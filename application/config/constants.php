...
define('F_DLT', '1207168795545512272');
define('D_DLT', '1207168795540827649');
define('V_DLT', '1207168795549985688');
// ----ccavenue -------------
...
// ----phone pe -------------
// define('PHONE_PE_URL', 'https://api-preprod.phonepe.com/apis/pg-sandbox/pg/v1/pay');//test
// define('PHONE_PE_SALT', 'e777554e-58ca-4847-8f19-72abac9eb6b3');//test
// define('PHONE_PE_MERCHANT_ID', 'PGTESTPAYUAT102'); //test 
define('PHONE_PE_URL', 'https://api.phonepe.com/apis/hermes');//live
define('PHONE_PE_SALT', 'bedb360d-55f4-4425-bcaa-d1f749229112');//live
define('PHONE_PE_MERCHANT_ID', 'DAIRYONLINE'); //live 
