...
<main>
                            ...
                            <div class="bd-breadcrumb__menu">
                                <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                    <ul class="trail-items">
                                        <li class="trail-item trail-begin"><span><a href="<?= base_url() ?>">Home</a></span></li>
            ...
            <section class="bd-serrvice__area service__bg">
                <div class="bd-trem__gallery pt-120">
                    <div class="container">
                        <div class="row">   
                            <div class="bd-gallery__button p-relative mb-40"><button data-filter=".c-1" class="btn1 active" onclick="fun1(1)">Feed</button><button data-filter=".c-2" class="btn2" onclick="fun1(2)">Breed</button><button data-filter=".c-3" class="btn3" onclick="fun1(3)">Management</button><button data-filter=".c-4" class="btn4" onclick="fun1(4)">Tools</button></div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bd-services__details-wrapper mb-60">
                                                        <div class="bd-services__details-thumb w-img mb-50"><img src="<?= base_url() ?>assets/frontend/img/service-details-01.jpg" alt="service-thumb"></div>
                                                        <div class="bd-services__details-content mb-40">
                                                            ...
                                                            <div class="bd-services__details-features mb-40">
                                                                <div class="bd-services__features-grid">
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/breed-icon-01.png" alt="features-icon"></span></div>
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/feed-icon-02.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/feed-icon-01.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/breed-icon-04.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/breed-icon-02.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                            ...
                                                            <div class="bd-services__founder mb-45">
                                                                <div class="bd-services__founder-content">
                                                                    <h3>With Dairy Muneem's feed management tools, you can track your cows' nutrition in real-time, make data-driven decisions about their feed, and optimize their diet for maximum health and productivity. </span>
                                                                </div>
                                                                <div class="bd-services__founder-icon"><img src="<?= base_url() ?>assets/frontend/img/service/details/message.png" alt=""></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="bd-services__details-area">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bd-services__details-wrapper mb-60">
                                                        <div class="bd-services__details-thumb w-img mb-50"><img src="<?= base_url() ?>assets/frontend/img/service-details-02.jpg" alt="service-thumb"></div>
                                                        <div class="bd-services__details-content mb-40">
                                                            <div class="bd-services__details-text mb-45">
                                                            ...
                                                            <div class="bd-services__details-features mb-40">
                                                                <div class="bd-services__features-grid">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/icon-02.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                            ...
                                                            <div class="bd-services__founder mb-45">
                                                                <div class="bd-services__founder-content">
                                                                    <h3>With Dairy Muneem's breed management tools, you can optimize your herd's genetics, improve breeding outcomes, and ensure the overall health and productivity of your herd.</span>
                                                                </div>
                                                                <div class="bd-services__founder-icon"><img src="<?= base_url() ?>assets/frontend/img/service/details/message.png" alt=""></div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="bd-services__details-area">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bd-services__details-wrapper mb-60">
                                                        <div class="bd-services__details-thumb w-img mb-50"><img src="<?= base_url() ?>assets/frontend/img/dairy-farm-tech-teaser.jpg" alt="service-thumb"></div>
                                                        <div class="bd-services__details-content mb-40">
                                                            <div class="bd-services__details-text mb-45">
                                                            ...
                                                            <div class="bd-services__details-features mb-40">
                                                                <div class="bd-services__features-grid">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/breed-icon-03.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/icon-01.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/info.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/handle-with-care.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                                                    ...
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/tank.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
                                    ...
                                    <div class="bd-services__details-area">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bd-services__details-wrapper mb-60">
                                                        <div class="bd-services__details-thumb w-img mb-50"><img src="<?= base_url() ?>assets/frontend/img/service-details-04.jpg" alt="service-thumb"></div>
                                                        <div class="bd-services__details-content mb-40">
                                                            <div class="bd-services__details-text mb-45">
                                                            ...
                                                            <div class="bd-services__details-features mb-40">
                                                                <div class="bd-services__features-grid">
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon"><span><img src="<?= base_url() ?>assets/frontend/img/service/details/icon-03.png" alt="features-icon"></span></div>
                                                                        <div class="bd-services__features-content">
