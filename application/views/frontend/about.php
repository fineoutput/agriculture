                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="bd-about__thumb w-img mb-60">
                                <table>
                                    <tr>
                                        <th colspan="3"><img src="<?= base_url() ?>assets/frontend/img/progress-step-tree.jpg"></th>
                                    </tr>
                            ...
                            <div class="bd-brand-active swiper-container">
                                <div class="swiper-wrapper">  
                                    <div class="swiper-slide">
                                        <div class="bd-single__brand"><a href="#"><img src="<?= base_url() ?>assets/frontend/img/Pandemic.png" alt="Pandemic-png"></a></div>
                                        <h5 class="text-center"><b>Pandemic,  increased demand  for professional  Dairy Service</b></h5>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bd-single__brand"><a href="#"><img src="<?= base_url() ?>assets/frontend/img/Population.png" alt="Population-png"></a></div>
                                        <h5 class="text-center"><b>Population Increase,  Rapid urbanization,  & growing  </b></h5>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bd-single__brand"><a href="#"><img src="<?= base_url() ?>assets/frontend/img/Establishment.png" alt="Establishment-png"></a></div>
                                        <h5 class="text-center"><b>Establishment of  leading multinational  companies </b></h5>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bd-single__brand"><a href="#"><img src="<?= base_url() ?>assets/frontend/img/Rising.png" alt="Rising-png"></a></div>
                                        <h5 class="text-center"><b>Rising disposable  incomes & Growing  Dairy sectors </b></h5>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bd-single__brand"><a href="#"><img src="<?= base_url() ?>assets/frontend/img/Favorable.png" alt="Favorable-png"></a></div>
