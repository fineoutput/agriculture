...
<head>
        ...
        <link rel="stylesheet" href="<?= base_url() ?>assets/frontend/css/swiper-bundle.css">
        <link rel="stylesheet" href="<?= base_url() ?>assets/frontend/css/backtotop.css">
        ...
        <link rel="stylesheet" href="<?= base_url() ?>assets/frontend/css/font-awesome-pro.css">
    ...
    <body>
        ...
        <div class="sidebar-btn">
            ...
            <div class="side-whatsapp-btn"><a href="https://wa.me/+91 7891029090"><i class="fa-brands fa-whatsapp"></i></a></div>
        </div>
                    ...
                    <div class="offcanvas__content">
                        <div class="offcanvas__top d-flex justify-content-between align-items-center">
                            <div class="offcanvas__logo logo">
                                <a href="<?=base_url()?>">
                                    <img src="<?= base_url() ?>assets/frontend/img/logo.png" height="" alt="logo">
                                </a>
                            </div>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="tel:+012-345-6789">
                                            <span class="mailto:dairymuneem@gmail.com">dairymuneem@gmail.com</span>
                                        </a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="offcanvas__social">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/profile.php?id=100092988491189" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/dairymuneem_dm/" target="_blank"><i class="fab fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/channel/UC_WTz7ccSTiFP8BWN9EeDUw" target="_blank"><i class="fab fa-youtube"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-lg-8 col-md-9 col-8">
                            <div class="bd-header__contact-spacing">
                                <div class="bd-header__contact">
                                    <ul>
                                        <li>
                                            <a href="mailto:dairymuneem@gmail.com">
                                                <i class="fa-solid fa-envelope-open"></i>dairymuneem@gmail.com 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="tel:+91 7891029090">
                                                <i class="fa-solid fa-phone"></i>+91 7891029090</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4  col-md-3 col-4">
                            <div class="bd-header__social text-end">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/profile.php?id=100092988491189" target="_blank">
                                            <i class="fa-brands fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/dairymuneem_dm/" target="_blank">
                                            <i class="fa-brands fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.youtube.com/channel/UC_WTz7ccSTiFP8BWN9EeDUw" target="_blank">
                                    ...
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    <li><a href="<?=base_url()?>Home/farmer">Farmer</a></li>
                                                    <li><a href="<?=base_url()?>Home/vendor">Vendor</a></li>
                                                    <li><a href="<?=base_url()?>Home/doctor">Doctor</a></li>
                                                </ul>
                                            </li>
                                ...
                                <div class="bd-header__hamburger">
                                    <div class="bd-header__hamburger-icon">
                                        <button class="side-toggle">
                                            <img src="<?= base_url() ?>assets/frontend/img/icon/hamburger-icon.png" alt="hamburger-icon">
                                        </button>
                                    </div>
                                </div>
                            </div>
