<footer>
            <section class="bd-footer__area green-bg foo p-relative pt-95">
                <div class="bd-footer__bg w-img"><img src="<?= base_url() ?>assets/frontend/img/bg/footer-bg.png" alt="footer-bg"></div>
                <div class="container">
                    <div class="row">
                            ...
                            <div class="bd-footer__widget footer-col-2 mb-60">
                                ...
                                <div class="bd-footer__link">
                                    <ul style="line-height: 2.5;">
                                        ...
                                        <li><a href="<?=base_url()?>Home/terms_and_conditions">Terms Of Service</a></li>
                                        <li><a href="<?=base_url()?>Home/refund_cancelation_policy">Cancelation Policy</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="bd-footer social-icon">
                                    <ul>
                                        ...
                                        <li style="line-height: 2; display: flex;">
                                            <i class="fa-solid fa-location-dot" style="margin-top:10px;"></i>House No. 98, Dream City, Suratgarh, Ganganagar-335804, Rajasthan</li>
                                    </ul>
                                    ...
                                    <div class="text-hlight">
                                        <p>This website owned by Agristar Animal Solution Private Limited</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="bd-copyright__main">
                                    <div class="bd-copyright__border">
                                        <div class="bd-copyright__text">
                                            <p>Copyright 2023 Dairy Muneem All Rights Reserved </p>
                                            <p>Design & Development By <span><a target="_blank" href="https://www.aspiretechnosys.com/">ASPIRE TECHNOSYS PVT LTD</a></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<?= base_url() ?>assets/frontend/js/vendor/waypoints.js"></script>
        <script src="<?= base_url() ?>assets/frontend/js/bootstrap-bundle.js"></script>
        <script src="<?= base_url() ?>assets/frontend/js/meanmenu.js"></script>
        ...
        <script src="<?= base_url() ?>assets/frontend/js/magnific-popup.js"></script>
        ...
        <script src="<?= base_url() ?>assets/frontend/js/imagesloaded-pkgd.js"></script>
