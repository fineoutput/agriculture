...
<main>
            <div class="bd-breadcrumb__area include__bg hero__overlay Breadcrumb__height d-flex align-items-center" data-background="<?= base_url() ?>assets/frontend/img/doctor-banner.jpg">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="bd-about__thumb w-img mb-60">
                                <img src="<?= base_url() ?>assets/frontend/img/service/details/doctor02.jpg" alt="about-thumb">
                            </div>
                        </div>
                        <div class="col-lg-6">
