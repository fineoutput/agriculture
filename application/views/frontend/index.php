<main>
                        ...
                        <div class="swiper-slide">
                            <div class="bd-singel__hero">
                                <div class="hero__height d-flex align-items-center p-relative">
                                    <a href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneem.com" target="_blank"><img src="<?= base_url() ?>assets/frontend/img/banner01.jpg" width="100%" alt=""></a>
                                    <!-- <div class="bd-hero__banner hero__overlay include__bg" data-background="<?= base_url() ?>assets/frontend/img/banner01.jpg"></div> -->
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="bd-singel__hero">
                                <div class="hero__height d-flex align-items-center p-relative">
                                    <a href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneemdoctor.com" target="_blank"><img src="<?= base_url() ?>assets/frontend/img/banner02.jpg" width="100%" alt=""></a>
                                    <!-- <div class="bd-hero__banner hero__overlay include__bg" data-background="<?= base_url() ?>assets/frontend/img/banner02.jpg"></div> -->
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="bd-singel__hero">   
                                <div class="hero__height d-flex align-items-center p-relative">
                                    <a href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneemvendor.com" target="_blank"><img src="<?= base_url() ?>assets/frontend/img/banner03.jpg" width="100%" alt=""></a>
                                    <!-- <div class="bd-hero__banner hero__overlay include__bg" data-background="<?= base_url() ?>assets/frontend/img/banner03.jpg"></div> -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="bd-features__area" data-background="<?= base_url() ?>assets/frontend/img/bg/section-bg.jpg">
                        ...
                        <div class="bd-features__item-wrapper pb-10" style="padding-top: 50px;">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6">
                                    <div class="bd-features__item text-center mb-60">
                                        <div class="" style="padding-bottom: 20px;">
                                            <a href="<?=base_url()?>Home/farmer"><img src="<?= base_url() ?>assets/frontend/img/service/details/farmer01.jpg" alt="features-image"></a>
                                        </div>
                                        <div class="bd-features__content">
                                            <h3><a href="<?=base_url()?>Home/farmer">FARMER</a></h3>
                                            <p>Our feed Features were designed to help you optimize your herd's nutrition and improve overall farm profitability. </p>   
                                            <a class="bd-link__btn" href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneem.com"><img src="<?= base_url() ?>assets/frontend/img/play-store.png" height="40px"></a>
                                            <a class="bd-link__btn" href="#"><img src="<?= base_url() ?>assets/frontend/img/apple-store.png" height="40px"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-6">
                                    <div class="bd-features__item text-center mb-60">
                                        <div class="" style="padding-bottom: 20px;">
                                            <a href="<?=base_url()?>Home/vendor"><img src="<?= base_url() ?>assets/frontend/img/service/details/vendor01.jpg" alt="features-image"></a>
                                        </div>   
                                        <div class="bd-features__content">
                                            <h3><a href="<?=base_url()?>Home/vendor">VENDOR</a></h3>
                                            <p>Overall Dairy muneem app creates a more connected ecosystem between vendors and farmers, </p>
                                            <a class="bd-link__btn" href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneemvendor.com"><img src="<?= base_url() ?>assets/frontend/img/play-store.png" height="40px"></a>
                                            <a class="bd-link__btn" href="#"><img src="<?= base_url() ?>assets/frontend/img/apple-store.png" height="40px"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12">
                                    <div class="bd-features__item text-center mb-60">
                                        <div class="" style="padding-bottom: 20px;">
                                            <a href="<?=base_url()?>Home/doctor"><img src="<?= base_url() ?>assets/frontend/img/service/details/doctor01.jpg" alt="features-image"></a>
                                        </div>
                                        <div class="bd-features__content">
                                            <h3><a href="<?=base_url()?>Home/doctor">DOCTOR</a></h3>
                                            <p>Doctor easily Connect with farmers. Online Consultation to the farmer. Doctor can maintain Semen Tank...</p>
                                            <a class="bd-link__btn" href="https://play.google.com/store/apps/details?id=com.fineoutput.dairymuneemdoctor.com"><img src="<?= base_url() ?>assets/frontend/img/play-store.png" height="40px"></a>
                                            <a class="bd-link__btn" href="#"><img src="<?= base_url() ?>assets/frontend/img/apple-store.png" height="40px"></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="bd-about__area pt-120 pb-55" data-background="<?= base_url() ?>assets/frontend/img/bg/section-bg.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="bd-about__image-wrapper p-relative mb-60">
                                <img class="bd-about__image-1" src="<?= base_url() ?>assets/frontend/img/about-img-01.jpg" alt="about-img">
                                <div class="bd-about__image-2 text-sm-end">
                                    <img src="<?= base_url() ?>assets/frontend/img/about-img-02.jpg" alt="about-img">
                                </div>
                                <div class="bd-about__shape">
                                    <img src="<?= base_url() ?>assets/frontend/img/about/about-cow.png" alt="about-cow-icon"><img class="bd-about__dashed-icon" src="<?= base_url() ?>assets/frontend/img/about/about-dashed.png" alt="about-dashed">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row pt-95 pb-90">
                        <div class="col-sm-12">
                            ...
                            <div id="headerPopup" class="mfp-hide embed-responsive embed-responsive-21by9">
                                <iframe class="embed-responsive-item" width="auto" height="480" src="<?= base_url() ?>assets/frontend/img/dairy-muneemVideo.mp4" frameborder="0"  allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="bd-gallery__area gallery__overlay fix pt-120 pb-120">
                <div class="bd-gallery__bg"><img src="<?= base_url() ?>assets/frontend/img/bg/gallery-bg.png" alt="gallery-bg"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="bd-gallery__item">
                                                <div class="bd-gallery__image w-img"><img src="<?= base_url() ?>assets/frontend/img/gallery-slid01.jpg" alt="gallery-image"></div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bd-gallery__item">
                                                <div class="bd-gallery__image w-img"><img src="<?= base_url() ?>assets/frontend/img/gallery-slid02.jpg" alt="gallery-image"></div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bd-gallery__item">
                                                <div class="bd-gallery__image w-img"><img src="<?= base_url() ?>assets/frontend/img/gallery-slid03.jpg" alt="gallery-image"></div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bd-gallery__item">
                                                <div class="bd-gallery__image w-img"><img src="<?= base_url() ?>assets/frontend/img/gallery-slid04.jpg" alt="gallery-image"></div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bd-gallery__item">
                                                <div class="bd-gallery__image w-img"><img src="<?= base_url() ?>assets/frontend/img/gallery-slid05.jpg" alt="gallery-image"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                          ...
                          <div class="bd-testimonial__card text-center mb-30">
                             <div class="bd-testimonial__text">
                                <div class="bd-testimonial__icon">
                                   <img src="<?= base_url() ?>assets/frontend/img/testimonial-icon.png" alt="testimonial-icon">
                                </div>
                                <p>happy customer</p>
                                ...
                                <div class="swiper-wrapper" id="swiper-wrapper-e6f5c5b5ddf82b98" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-1550px, 0px, 0px);">
                                   <div class="swiper-slide" role="group" aria-label="1 / 3" style="width: 765px; margin-right: 10px;">
                                      <div class="bd-testimonial__content">
                                         ...
                                         <img src="<?= base_url() ?>assets/frontend/img/farmer-testimonial.jpg">
                                   ...
                                   <div class="swiper-slide" role="group" aria-label="2 / 3" style="width: 765px; margin-right: 10px;">
                                      <div class="bd-testimonial__content">
                                         ...
                                         <img src="<?= base_url() ?>assets/frontend/img/vendor-testimonial.jpg">
                                   ...
                                   <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 765px; margin-right: 10px;">
                                      <div class="bd-testimonial__content">
                                         ...
                                         <img src="<?= base_url() ?>assets/frontend/img/doctor-testimonial.jpg">
