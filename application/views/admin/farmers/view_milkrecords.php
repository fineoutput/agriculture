                                    ...
                                    <section class="content-header">
                                      ...
                                      <ol class="breadcrumb">
                                       <li><a href="<?php echo base_url() ?>dcadmin/home"><i class="fa fa-dashboard"></i> Home</a></li>
                                        ...
                                        <li class="active">View Milk RECORDS</li>
                                      </ol>
                                    </section>
                                         ...
                                         <div class="col-lg-12">
                                                          ...
                                                          <div class="panel panel-default">
                                                              <div class="panel-heading">
                                                                  <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Milk RECORDS</h3>
                                                              </div>
                                                                 <div class="panel panel-default">
                                                                  ...
                                                                  <table class="table table-bordered table-hover table-striped" id="userTable">
                                                                      <thead>
                                                                          <tr>
                                                                            ...
                                                                            <tbody>
<?php $i=1; foreach($data_milk_records->result() as $data) { ?>
                                                    <tr>
                                                    <td><?php echo $i; ?> </td>
