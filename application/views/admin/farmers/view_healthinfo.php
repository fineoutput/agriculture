                                    ...
                                    <section class="content-header">
                                      ...
                                      <ol class="breadcrumb">
                                       <li><a href="<?php echo base_url() ?>dcadmin/home"><i class="fa fa-dashboard"></i> Home</a></li>
                                        <li><a href="<?php echo base_url() ?>dcadmin/Farmers/viewrecords/<?echo $farmer_id; ?>"><i class="fa fa-dashboard"></i> All  HEALTH INFO</a></li>
                                        <li class="active">View HEALTH INFO</li>
                                      </ol>
                                    </section>
                                         ...
                                         <div class="col-lg-12">
                                                          ...
                                                          <div class="panel panel-default">
                                                              <div class="panel-heading">
                                                                  <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View HEALTH INFO</h3>
                                                              </div>
                                                                 <div class="panel panel-default">
                                                                  ...
                                                                  <table class="table table-bordered table-hover table-striped" id="userTable">
                                                                      <thead>
                                                                          <tr>
                                                                            ...
                                                                            <tbody>
<?php $i=1; foreach($data_health_info->result() as $data) { ?>
                                                    <tr>
                                                    <td><?php echo $i; ?> </td>
