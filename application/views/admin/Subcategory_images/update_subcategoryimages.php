                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url() . $subcategory_images->image_hindi ?>">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url() . $subcategory_images->image_punjabi ?>">
                      </td>
                    </tr>
                    <td colspan="2">
