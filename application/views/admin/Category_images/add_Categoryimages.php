      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action="<?php echo base_url() ?>dcadmin/Category_images/add_Categoryimages_data/<? echo base64_encode(2); ?>/<? echo $id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
