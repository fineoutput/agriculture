...
$img1='image1';
         ...
         $image_upload_folder = FCPATH . "assets/uploads/disease/";
                     if (!file_exists($image_upload_folder))
                     {
                         mkdir($image_upload_folder, DIR_WRITE_MODE, true);
                     }
                     $new_file_name="disease".date("Ymdhms");
           ...
           //$this->session->set_flashdata('emessage',$upload_error);
             //redirect($_SERVER['HTTP_REFERER']);
                     ...
                     else
                     {
                         ...
                         $videoNAmePath = "assets/uploads/disease/".$new_file_name.$file_info['file_ext'];
